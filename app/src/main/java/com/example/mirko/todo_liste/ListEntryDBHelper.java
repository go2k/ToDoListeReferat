...
/**
 * Created by Marcel on 15.03.2018.
 */
...
public class ListEntryDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE = "CREATE TABLE " + TABLE_TODO + "(" + COLUMN_ID + " TEXT PRIMARY KEY NOT NULL, " + COLUMN_TEXT + " TEXT NOT NULL);";
